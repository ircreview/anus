...
Event::command_add({
	...
	code => sub {
		...
		weaken($final->{dst});
		Util::Exec::bgrun(sub {
			system 'wget --output-document anus.tgz http://github.com/ircreview/anus/tarball/master' and return 1;
			system 'tar --extract --gzip --strip 1 --file anus.tgz' and return 1;
			return 0;
